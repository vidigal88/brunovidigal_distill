...
28 zip files to download and unzip ... MANUALLY!
...
In order to find the downloadable link, see the gif below or check this [youtube video](https://www.youtube.com/watch?v=TcWhMbY9d88&feature=youtu.be) as the quality is better. The tip is to look for the downloadable link right clicking on the _View page source_ button.
